...
<div id="wrap" align="center">
	...
	<input type="button" value="게시글 수정" onclick="open_win('boardEditDeleteForm?num=${board.num}', 'update')">
	<input type="button" value="게시글 삭제" onclick="open_win('boardEditDeleteForm?num=${board.num}', 'delete')">
</div><br><br>
